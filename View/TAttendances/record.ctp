<div class="tAttendances index">
  <h2><?php echo __('T Attendances'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tAttendance['TAttendance']['id']), null, __('Are you sure you want to delete # %s?', $tAttendance['TAttendance']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
